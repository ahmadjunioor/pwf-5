                    ...
                    <table class="w-full text-left">
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            <tr class="py-3">
                                ...
                                <td class="py-3 text-gray-800 dark:text-gray-200">Junior Ahmad Faisal</td>
                            </tr>
                            <tr>
                                <td class="py-3 pr-8 font-semibold text-gray-600 dark:text-gray-400">NIM</td>
                                <td class="py-3 text-gray-800 dark:text-gray-200">20230140215</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="py-3 text-gray-800 dark:text-gray-200">Musik</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
